...
function getPreOnServiceTerms(termsSeq) {
	$.ajax({
	    url: '/terms/getPreOnServiceTerms',
	    type : "GET",
	    ...
	    success: function(result) {
	    	...
	    	viewPreTerms(result["onlineServiceTerms"]);
	    },
	    error: function(e) {
...
<div class="container">
	...
	<div class="lineMap">
		<div class="path">
			...
			<span class="current">온라인 서비스 이용약관</span>
		</div>
	</div><!-- // lineMap -->
					...
					<div class="list" id="termList2">
						<ul class="termsList">
							<c:forEach items="${preOnlineServiceTerms}" var="preTerms">
								...
								<li><a href="javascript:getPreOnServiceTerms(${preTerms.termsSeq});" rel="external"><span class="num">v ${preTerms.termsVer}</span><span class="txt">${operDate}</span></a></li>
							</c:forEach>
						</ul>
					</div><!-- // list -->
				</li>
